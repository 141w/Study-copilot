    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          className="absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-foreground/20 active:bg-foreground/30 transition-colors"
        >
          <div className="absolute right-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-border group-hover:bg-foreground/60 transition-colors" />
        </div>
      )}
      ...
      <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
        ...
        <div className="h-10 flex items-center justify-between shrink-0 relative mt-3 mb-1 px-3">
          ...
          >
            <img src="/logo-horizontal.png" alt="AI 互动课堂" className="h-6" />
          </button>
          <button
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isActive &&
                      !isFailed &&
                      'bg-card ring-1 ring-primary shadow-sm opacity-100',
                  )}
                >
                  {/* Scene Header */}
                  <div className="flex justify-between items-center px-2 pt-0.5">
