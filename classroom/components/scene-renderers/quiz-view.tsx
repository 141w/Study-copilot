  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
        <PieChart className="w-52 h-52 text-foreground" />
      </div>
      <div className="absolute bottom-0 left-0 p-6 opacity-[0.02]">
        <BookOpenText className="w-40 h-40 text-foreground rotate-12" />
      </div>
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-card rounded-2xl flex items-center justify-center shadow-lg border border-border"
      >
      ...
      >
        <div className="flex items-center gap-2 text-muted-foreground">
          <div className="w-7 h-7 rounded-lg bg-muted flex items-center justify-center">
            <BookOpenText className="w-3.5 h-3.5 text-foreground" />
          </div>
          <span>
        ...
        <div className="flex items-center gap-2 text-muted-foreground">
          <div className="w-7 h-7 rounded-lg bg-muted flex items-center justify-center">
            <PieChart className="w-3.5 h-3.5 text-foreground" />
          </div>
          <span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-primary text-primary-foreground rounded-full font-medium shadow-md hover:opacity-90 transition-opacity z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-border text-sm resize-none focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all disabled:bg-muted disabled:text-muted-foreground bg-card text-foreground placeholder:text-muted-foreground"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-muted border border-border">
              ...
              <span className="ml-auto text-xs font-bold text-foreground shrink-0">
...
function QuestionCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'bg-card rounded-2xl border p-5 relative overflow-hidden',
        !isReview && 'border-border shadow-sm',
        isReview &&
    ...
    <div className="w-full h-full bg-background overflow-hidden flex flex-col">
      <AnimatePresence mode="wait">
        ...
        {phase === 'answering' && (
          ...
          >
            {/* Header bar */}
            <div className="flex items-center justify-between px-6 py-3 border-b border-border bg-card/80 backdrop-blur shrink-0">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-border bg-card/80 backdrop-blur shrink-0">
              ...
              <button
                ...
                disabled={retrying}
                className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors disabled:cursor-not-allowed disabled:opacity-50"
              >
