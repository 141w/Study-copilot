      ...
      >
        ...
        {!collapsed && (
          <div
            ...
            className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-foreground/20 active:bg-foreground/30 transition-colors"
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-border group-hover:bg-foreground/60 transition-colors" />
          </div>
        )}
