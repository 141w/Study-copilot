...
| `MemoryItem` | `memory_items` | id, user_id, kind (profile/preference/fact/task/interest), origin, status, key, content, superseded_at |
| `MemorySubject` | `memory_subjects` | user_id (PK), enabled, block_text, capacity, last_extracted_at |
